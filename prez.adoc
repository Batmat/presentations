...
a| image:github.png[GitHub,width=24,link="https://github.com/batmat/",title="GitHub"] 
link:https://github.com/batmat[batmat] +
image:twitter.png[Twitter,width=24,link="http://twitter.com/bmathus",title="Twitter"] 
